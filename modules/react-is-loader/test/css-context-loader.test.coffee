...
context = require('../lib/css-context-loader')
...
describe 'CSS Context Loader', ->
  ...
  it 'should translate `is` to style on html elements', ->
    ...
    before = 'React.createElement("div", { "is": "conversationColumn" })'
    after = 'React.createElement("div", { "style": this.styles().conversationColumn })'
  ...
  it 'should translate `is` to styles on custom components', ->
    ...
    before = 'React.createElement(Custom, { "is": "conversationColumn" })'
    after = 'React.createElement(Custom, { "style": this.styles().conversationColumn })'
